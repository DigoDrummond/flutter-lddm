...
import 'login.dart'; // Importe sua página de login
...
class _CadastroPageState extends State<CadastroPage> {
  ...
  final TextEditingController _telefoneController =
      TextEditingController(); // Adicionado para o telefone
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        onTap: (index) {
          if (index == 1) {
            // Redireciona para a página de login ao clicar no ícone de login
            Navigator.push(
              context,
